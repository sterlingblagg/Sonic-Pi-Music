...
define :part3 do |a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z|
  play a, sustain: 4
  play b
  play c
  sleep 0.5
...
#play6
part3 :g2, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, :b3, :f4, 2.5
